...
# if not spark.catalog.tableExists("databricks_riigieelarve") or spark.table("databricks_riigieelarve").isEmpty() or \
#     not spark.catalog.tableExists("eval_set_databricks_riigieelarve") or spark.table("eval_set_databricks_riigieelarve").isEmpty():
#   spark.sql('''CREATE TABLE IF NOT EXISTS databricks_riigieelarve (
#             id BIGINT GENERATED BY DEFAULT AS IDENTITY,
#             url STRING,
#             content STRING
#           ) TBLPROPERTIES (delta.enableChangeDataFeed = true)''')
#   (spark.createDataFrame(pd.read_parquet('https://notebooks.databricks.com/demos/dbdemos-dataset/llm/databricks-documentation/databricks_documentation.parquet'))
#    .drop('title').write.mode('overwrite').saveAsTable("databricks_riigieelarve"))
# #   (spark.createDataFrame(pd.read_parquet('https://notebooks.databricks.com/demos/dbdemos-dataset/llm/databricks-documentation/databricks_doc_eval_set.parquet'))
# #    .write.mode('overwrite').saveAsTable("eval_set_databricks_documentation"))
#   #Make sure enableChangeDataFeed is enabled
#   spark.sql('ALTER TABLE databricks_riigieelarve SET TBLPROPERTIES (delta.enableChangeDataFeed = true)')
