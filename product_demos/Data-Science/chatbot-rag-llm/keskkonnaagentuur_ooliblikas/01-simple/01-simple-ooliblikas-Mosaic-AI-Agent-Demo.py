...
# MAGIC SELECT id, url, content FROM databricks_pdf_ooliblikas; 
...
MODEL_NAME = "ooliblikas_rag_simple"
...
instructions_to_reviewer = f"""## Instructions for Testing the Databricks Ööliblikas Assistant chatbot
...
# MAGIC %md 
# MAGIC For next step need to create evaluation dataset!
