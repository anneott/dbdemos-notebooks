...
# MAGIC SELECT id, url, content FROM databricks_pdf_riigieelarve; -- should be id, url, content
...
source_table_fullname = f"{catalog}.{db}.databricks_pdf_riigieelarve"
# Where we want to store our index
vs_index_fullname = f"{catalog}.{db}.databricks_pdf_riigieelarve_vs_index"
...
chain_config = {
    ...
    "vector_search_index": f"{catalog}.{db}.databricks_pdf_riigieelarve_vs_index",
...
(f"dbdemos_rag_{catalog}-{db}-{MODEL_NAME}")
...
instructions_to_reviewer = f"""## Instructions for Testing the Databricks Riigieelarve Assistant chatbot
